...
describe('CheckInDao', () => {
    ...
    it('should find one', async () => {
        const doc = { _id: '1', latitude: '0', longitude: '0', datetime: new Date(), projectId: 'p1', userId: 'u1', contributesTo: '', taskType: 'T' };
    ...
    it('should create', async () => {
        const checkin = {
            latitude: '0', longitude: '0', date: new Date(), projectId: 'p1', user: { id: 'u1' }, contributesTo: '', taskType: 'T'
        } as any;
