...
describe('BasicPointsEngine', () => {
    ...
    describe('reward', () => {
        it('should calculate points based on rules', () => {
            ...
            const game = {
                project: {
                    ...
                    gamification: {
                        pointRules: [
                            { taskType: 'type1', areaId: 'Cualquiera', timeIntervalId: 'Cualquiera', score: 10, mustContribute: true },
                            { taskType: 'type2', areaId: 'Cualquiera', timeIntervalId: 'Cualquiera', score: 5, mustContribute: false },
                        ],
                    },
                },
            } as any;
        ...
        it('should return 0 if area is not found and not "Cualquiera"', () => {
            const ch = { latitude: '0', longitude: '0', taskType: 'type1', date: new Date(), contributesTo: 'task1' } as any;
            const game = {
                project: {
                    areas: { features: [] },
                    timeIntervals: [],
                    gamification: {
                        pointRules: [{ taskType: 'type1', areaId: 'specificArea', timeIntervalId: 'Cualquiera', score: 10, mustContribute: false }],
                    },
                },
            } as any;
        ...
        it('should return points if area matches via GeoUtils', () => {
            const ch = { latitude: '0.5', longitude: '0.5', taskType: 'type1', date: new Date(), contributesTo: 'task1' } as any;
            ...
            const game = {
                project: {
                    ...
                    timeIntervals: [],
                    gamification: {
                        pointRules: [{ taskType: 'type1', areaId: 'a1', timeIntervalId: 'Cualquiera', score: 10, mustContribute: false }],
                    },
                },
            } as any;
    ...
    describe('calculatePoints', () => {
        it('should calculate points for a task', () => {
            ...
            const project = {
                gamification: {
                    pointRules: [
                        { matchTask: jest.fn().mockReturnValue(true), score: 10, mustContribute: true },
                        { matchTask: jest.fn().mockReturnValue(false), score: 5, mustContribute: true },
                    ],
                },
            } as any;
        ...
        it('should return 0 if no rule matches', () => {
            ...
            const project = {
                gamification: {
                    pointRules: [
                        { matchTask: jest.fn().mockReturnValue(false), score: 10, mustContribute: true },
                    ],
                },
            } as any;
