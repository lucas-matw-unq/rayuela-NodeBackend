...
describe('BadgesFirstLBEngine', () => {
    ...
    it('should sort users by badges then points', () => {
        ...
        const user1 = {
            id: 'u1',
            username: 'user1',
            getGameProfileFromProject: jest.fn().mockReturnValue({ points: 10, badges: ['b1'] }),
        } as any;
        const user2 = {
            id: 'u2',
            username: 'user2',
            getGameProfileFromProject: jest.fn().mockReturnValue({ points: 20, badges: ['b1', 'b2'] }),
        } as any;
        const user3 = {
            id: 'u3',
            username: 'user3',
            getGameProfileFromProject: jest.fn().mockReturnValue({ points: 30, badges: ['b1'] }),
        } as any;
