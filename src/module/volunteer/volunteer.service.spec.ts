...
describe('VolunteerService', () => {
    ...
    describe('subscribeToProject', () => {
        it('should subscribe if not already subscribed', async () => {
            const userJwt = { userId: 'user1', username: 'test', role: UserRole.Volunteer };
            const user = new User('Test', 'test', 'test@test.com', 'pass', '', false, UserRole.Volunteer);
