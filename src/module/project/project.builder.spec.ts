...
import { GamificationStrategy, LeaderboardStrategy, RecommendationStrategy } from './dto/create-project.dto';
...
describe('ProjectBuilder', () => {
    it('should build a project with custom values', () => {
        ...
        expect(project.recommendationStrategy).toBe(RecommendationStrategy.ADAPTIVE);
